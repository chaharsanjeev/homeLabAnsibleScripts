...
# 0 * * * * curl -sKL https://raw.githubusercontent.com/chaharsanjeev/homeLabAnsibleScripts/main/linux/qnap_hdd_main.sh  | sudo bash >> /dev/null 2>&1 #below added by sanjeev to send HDD details to node-red, run every hour
